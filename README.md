...
### 🚀 Full-Stack Developer | .NET, React, Python & PHP

¡Hola! Soy un desarrollador versátil enfocado en construir APIs robustas con **.NET** y **Python (Django)**, así como frontends modernos con **React** y soluciones en **PHP**. Me apasiona la arquitectura limpia, la seguridad y crear proyectos escalables.
...
[![My Skills](https://skillicons.dev/icons?i=dotnet,cs,react,ts,js,python,django,php,html,css,tailwind,git,github,vscode,postman)](https://skillicons.dev)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/abraham-zavala)
...
```javascript
const abraham = {
  languages: [".NET (C#)", "React (TS/JS)", "Python (Django)", "PHP"],
  architecture: ["REST APIs", "Microservices", "Clean Architecture"],
  database: ["SQL Server", "PostgreSQL", "MySQL", "Entity Framework Core"],
  currentFocus: "Desarrollando soluciones Full-Stack escalables y explorando arquitectura Cloud",
  funFact: "Siempre hay café de por medio cuando compilo"
};
